...
import com.example.groceryapp.databinding.FragmentBeefSubProductBinding
...
class BeefSubProductFragment(private val subCategoryDataList: List<SubCategoryData>) : Fragment() {
    private lateinit var binding: FragmentBeefSubProductBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_beef_sub_product,
            container,
            false
        )
