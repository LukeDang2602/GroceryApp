...
class VeggiesSubProductFragment(private val subCategoryDataList: List<SubCategoryData>) : Fragment() {
    private lateinit var binding: FragmentVeggiesSubProductBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_veggies_sub_product,
            container,
            false
        )
