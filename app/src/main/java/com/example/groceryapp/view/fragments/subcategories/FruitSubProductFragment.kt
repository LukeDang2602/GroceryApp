...
import com.example.groceryapp.databinding.FragmentFruitSubProductBinding
import com.example.groceryapp.databinding.FragmentVeggiesSubProductBinding
...
class FruitSubProductFragment(private val subCategoryDataList: List<SubCategoryData>) : Fragment() {
    private lateinit var binding: FragmentFruitSubProductBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_fruit_sub_product,
            container,
            false
        )
